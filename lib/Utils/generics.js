...
const generateMessageIDV2 = (userId) => {
    ...
    return 'Surtalogi The Foul (5 Sinner From Khaenriah) ' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'Surtalogi The Foul (5 Sinner From Khaenriah) ' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
